...
function parseFloatingPop(row) {
    ...
    return {
        ...
        byTime: {
            '00~06시': parseInt(row.TMZON_1_FLPOP_CO) || 0,
            '06~11시': parseInt(row.TMZON_2_FLPOP_CO) || 0,
            '11~14시': parseInt(row.TMZON_3_FLPOP_CO) || 0,
            '14~17시': parseInt(row.TMZON_4_FLPOP_CO) || 0,
            '17~21시': parseInt(row.TMZON_5_FLPOP_CO) || 0,
            '21~24시': parseInt(row.TMZON_6_FLPOP_CO) || 0,
        },
        byDay: {
...
function parseSales(row) {
    ...
    return {
        ...
        byTime: {
            '00~06시': parseInt(row.TMZON_1_SELNG_AMT) || 0,
            '06~11시': parseInt(row.TMZON_2_SELNG_AMT) || 0,
            '11~14시': parseInt(row.TMZON_3_SELNG_AMT) || 0,
            '14~17시': parseInt(row.TMZON_4_SELNG_AMT) || 0,
            '17~21시': parseInt(row.TMZON_5_SELNG_AMT) || 0,
            '21~24시': parseInt(row.TMZON_6_SELNG_AMT) || 0,
        },
        byGender: {
